...
The actual script is located in the maintenance directory.

To run database migrations, use:
    python ../maintenance/manage_database.py
...
# ../maintenance/manage_database.py

print("Database migration script is located at: ../maintenance/manage_database.py")
...
if __name__ == "__main__":
    ...
    script_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "maintenance", "manage_database.py")
