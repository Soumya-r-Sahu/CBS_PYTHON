...
This friendly tool helps maintain your banking database in optimal condition.
It handles critical tasks like:
 
• Creating and updating tables to match your code models
• Performing routine database maintenance for better performance
• Creating default data for new installations
• Keeping your database healthy and efficient

Use this tool regularly as part of your banking system maintenance.
"""
import os
import sys
import argparse
...
try:
    ...
    print("   Please check that database/python/models.py exists and is properly configured")
    sys.exit(1)

def run_migration(verbose=False):
    """
    Update database tables to match your latest code changes
