"""
NEFT transaction validation domain service.
This service handles business rules for validating NEFT transactions.
"""
from typing import Optional
from ..entities.neft_transaction import NEFTPaymentDetails


class NEFTValidationService:
    """Domain service for validating NEFT transactions."""
    
    def __init__(self, per_transaction_limit: float = 10000000.0):
        """
    ...
    def validate_payment_details(self, payment_details: NEFTPaymentDetails) -> Optional[str]:
        """
