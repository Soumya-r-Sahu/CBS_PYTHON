-- Stored procedures for Core Banking System
...
-- NEW PROCEDURE: Process fund transfer (simplified)
...
-- Simple trigger for demonstration
CREATE TRIGGER cbs_accounts_after_update
AFTER UPDATE ON cbs_accounts
FOR EACH ROW
BEGIN
    -- Simplified version (no actual inserts)
