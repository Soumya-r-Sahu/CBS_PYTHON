...
class APIGateway:
    """API Gateway service for routing and managing requests"""
    ...
    def __init__(self, config: GatewayConfig):
        ...
        self.service_router = ServiceRouter(config.services)
        self.health_checker = HealthChecker(config.services)
    ...
    def _setup_routes(self, app: FastAPI):
        ...
        async def route_audit_service(
            ...
            """Route requests to audit service"""
            return await self._route_to_service("audit-service", request, path, token_data)
