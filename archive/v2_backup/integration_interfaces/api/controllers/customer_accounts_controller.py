...
This module provides a friendly interface for customers to access their
banking accounts through the mobile and web applications. It handles:

• Viewing account details and balances 
• Checking transaction history and statements
• Managing account preferences and settings
• Setting up alerts and notifications

The API ensures secure access to customer financial information.
"""
...
def get_user_accounts(current_user):
    ...
    This endpoint returns a list of all accounts owned by the customer,
    including savings, checking, loans, and fixed deposits with their
