"""
Refactored Email OTP Authentication Module for Core Banking System

This module implements email-based One-Time Password (OTP) authentication
for the Core Banking System using the unified error handling and design patterns.
"""
...
# Define OTP-specific error codes
class OTPErrorCodes:
...
class EmailOTPManager:
    ...
    def __init__(
        ...
        Args:
            ...
            numeric_only: If True, generate only numeric OTPs
            max_verification_attempts: Maximum verification attempts before OTP is invalidated
        """
    ...
    def send_otp_email(self, email: str, user_id: str, purpose: str = "authentication") -> bool:
        ...
        Args:
            ...
            user_id: User identifier
            purpose: Purpose of OTP (for customizing message)
            
        Returns:
            True if OTP was successfully sent, False otherwise
            
        Raises:
            ValidationException: If email or user_id is invalid
        """
...
"""
    ...
    def verify_otp(self, user_id: str, otp_code: str) -> Tuple[bool, str]:
        ...
        Raises:
            NotFoundException: If no active OTP exists for the user
            ValidationException: If the OTP is expired or invalid
        """
...
if __name__ == "__main__":
    ...
    # Create OTP manager - now uses singleton pattern
